...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  // 100% Free Forever Storage & Database Settings (Zero Billing / No Credit Card Required)
  storageMode: 'free-local',
...
export const INITIAL_PHOTOS: PhotoItem[] = [
  ...
  },
  {
    ...
    caption: 'Golden turmeric paste blessings and floral petals shower',
    moment: 'Haldi',
    coupleName: 'Aashi & Dev',
    date: '2026-01-10',
    featured: true,
  ...
  },
  {
    ...
    caption: 'Delicate peacock henna patterns adorning palms for the wedding eve',
    moment: 'Mehendi',
    coupleName: 'Aashi & Dev',
    date: '2026-01-11',
    featured: false,
  ...
  },
  {
    ...
    caption: 'High-energy dhol rhythm and synchronised family dance celebration',
    moment: 'Sangeet',
    coupleName: 'Tanvi & Harsh',
    date: '2025-12-22',
    featured: true,
  ...
  {
    id: 'photo_16',
    image: 'https://images.unsplash.com/photo-1609151162377-794fa68b02f6?q=80&w=1200&auto=format&fit=crop',
    caption: 'The magical Varmala garland exchange under a shower of rose petals',
    moment: 'Wedding Ceremony',
    coupleName: 'Tanvi & Harsh',
    date: '2025-12-23',
    featured: true,
  ...
  },
  {
    ...
    caption: 'Grand reception entry under cold fire sparklers and warm cheers',
    moment: 'Reception',
    coupleName: 'Kritika & Yash',
    date: '2026-02-12',
    featured: true,
  ...
  },
  {
    ...
    caption: 'A secluded morning shoot amidst heritage fort arches and tranquil waters',
    moment: 'Pre-Wedding Shoot',
    coupleName: 'Kritika & Yash',
    date: '2025-11-05',
    featured: false,
  ...
  },
  {
    ...
    caption: 'Twilight serenity — whispering forever against the sunset horizon',
    moment: 'Couple Portraits',
    coupleName: 'Shruti & Aman',
    date: '2026-01-28',
    featured: true,
  ...
  },
  {
    ...
    caption: 'The bride walking down the aisle under the phoolon ki chaadar',
    moment: 'Wedding Ceremony',
    coupleName: 'Shruti & Aman',
    date: '2026-01-29',
    featured: false,
  ...
  },
  {
    ...
    caption: 'A radiant bridal portrait capturing the quiet serenity before ceremonies',
    moment: 'Candid Moments',
    coupleName: 'Neha & Prateek',
    date: '2025-12-08',
    featured: false,
  ...
  },
  {
    ...
    caption: 'The groom sharing a joyful laugh with his brothers before the baraat',
    moment: 'Candid Moments',
    coupleName: 'Neha & Prateek',
    date: '2025-12-08',
    featured: false,
  ...
  },
  {
    ...
    caption: 'Champagne toast and heartfelt laughter under the chandelier ballroom',
    moment: 'Reception',
    coupleName: 'Roshni & Kunal',
    date: '2026-02-18',
    featured: false,
  ...
  },
  {
    ...
    caption: 'Confetti and sparkler farewell send-off into their new journey together',
    moment: 'Candid Moments',
    coupleName: 'Roshni & Kunal',
    date: '2026-02-18',
    featured: true,
